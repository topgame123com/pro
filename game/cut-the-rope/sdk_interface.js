const SDK_LOG = (msg) => {
  ...
  return console.log(`%c[Famobi]%c%s`, 'color:white; background-color: black;', 'color: black', msg);
};
...
const SDK_INTERFACE_REWARDED_AD = function () {
  return new Promise(function (resolve, reject) {
    ...
    onRequestAd("rewarded", callbacks);
  });
};
