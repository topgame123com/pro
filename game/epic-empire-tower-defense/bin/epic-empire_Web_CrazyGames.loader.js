function createUnityInstance(e, t, n) {
    ...
    function o(e) {
        ...
        (n += '\n' + (r = r.startsWith(n) ? r.substring(n.length) : r).trim()) && s.stackTraceRegExp && s.stackTraceRegExp.test(n) && D(n, e.filename || (t && (t.fileName || t.sourceURL)) || '', e.lineno || (t && (t.lineNumber || t.line)) || 0);
    }
    function a(e, t, n) {
        var r = e[t];
    ...
    var f,
        ...
        C = {
            ...
            GetMemoryInfo: function () {
                var e = s._getMemInfo();
                return { totalWASMHeapSize: s.HEAPU32[e >> 2], usedWASMHeapSize: s.HEAPU32[1 + (e >> 2)], totalJSHeapSize: s.HEAPF64[1 + (e >> 3)], usedJSHeapSize: s.HEAPF64[2 + (e >> 3)] };
            },
        };
    function D(e, t, n) {
                  ...
                  D.didShowErrorMessage ||
                      (-1 != (e = 'An error occurred running the Unity content on this page. See your browser JavaScript console for more info. The error was:\n' + e).indexOf('DISABLE_EXCEPTION_CATCHING')
                          ...
                          : -1 != e.indexOf('Cannot enlarge memory arrays')
                            ...
                            : (-1 == e.indexOf('Invalid array buffer length') && -1 == e.indexOf('Invalid typed array length') && -1 == e.indexOf('out of memory') && -1 == e.indexOf('could not allocate memory')) || (e = 'The browser could not allocate enough memory for the WebGL content. If you are the developer of this content, try allocating less memory to your WebGL build in the WebGL player settings.'),
                      alert(e),
    ...
    function x(e, t) {
        if ('symbolsUrl' != e) {
            var r = s.downloadProgress[e],
                o = ((r = r || (s.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 })), 'object' != typeof t || ('progress' != t.type && 'load' != t.type) || (r.started || ((r.started = !0), (r.lengthComputable = t.lengthComputable)), (r.total = t.total), (r.loaded = t.loaded), 'load' == t.type && (r.finished = !0)), 0),
                a = 0,
                i = 0,
                c = 0,
                u = 0;
    ...
    return (
        ...
        (s.readBodyWithProgress = function (e, t, n) {
            var r = e.body ? e.body.getReader() : void 0,
                ...
                u = 0;
            return (
                o || console.warn('[UnityCache] Response is served without Content-Length header. Please reconfigure server to include valid Content-Length for better download performance.'),
                (function d() {
                    return void 0 === r
                        ? e.arrayBuffer().then(function (r) {
                              var a = new Uint8Array(r);
                              return (t({ type: 'progress', response: e, total: r.length, loaded: 0, lengthComputable: o, chunk: n ? a : null }), a);
                          })
                        : r.read().then(function (r) {
                              ...
                              return (c + r.value.length <= i.length ? (i.set(r.value, c), (u = c + r.value.length)) : s.push(r.value), (c += r.value.length), t({ type: 'progress', response: e, total: Math.max(a, c), loaded: c, lengthComputable: o, chunk: n ? r.value : null }), d());
                          });
                })().then(function (n) {
                    return (t({ type: 'load', response: e, total: n.length, loaded: n.length, lengthComputable: o, chunk: null }), (e.parsedBody = n), e);
                })
            );
        }),
                            ...
                            function (r, o) {
                                try {
                                    ...
                                    null === this.database
                                        ...
                                        : ((a = -1 != ['put', 'delete', 'clear'].indexOf(t) ? 'readwrite' : 'readonly'),
            ...
            (E.prototype.getMetaDataEntries = function () {
                ...
                return new Promise(function (r, o) {
                    ...
                    ((a.onsuccess = function (e) {
                        (e = e.target.result) ? ((t += e.value.size), n.push(e.value), e.continue()) : r({ metaDataEntries: n, cacheSize: t });
                    }),
                ...
                return this.getMetaDataEntries().then(function (t) {
                    ...
                    for (
                        a.sort(function (e, t) {
                            ...
                            i = 0;
                        i < a.length && !(r < E.MaximumCacheSize);
                        ++i
                    )
                        (o.push(a[i]), (r -= a[i].size));
                    return (function t() {
                        var n;
                        return 0 === o.length
                            ? Promise.resolve()
        ...
        (s.cachedFetch =
            ((y = s.UnityCache),
            (w = s.fetchWithProgress),
            (S = s.readBodyWithProgress),
            function (e, t) {
                var n,
                    r,
                    o = y.getInstance(),
                    a = U('string' == typeof e ? e : e.url),
                    i = { enabled: ((n = a), !(((r = t) && r.method && 'GET' !== r.method) || (r && -1 == ['must-revalidate', 'immutable'].indexOf(r.control)) || !n.match('^https?://'))) };
                function s(e, t) {
                    return fetch(e, t).then(function (n) {
                        var r;
                        return !i.enabled || i.revalidated
                            ? n
                            : 304 === n.status
                              ? ((i.revalidated = !0),
                                o
                                    .updateRequestMetaData(i.metaData)
                                    .then(function () {
                                        P("'" + i.metaData.url + "' successfully revalidated and served from the indexedDB cache");
                                    })
                                    .catch(function (e) {
                                        P("'" + i.metaData.url + "' successfully revalidated but not stored in the indexedDB cache due to the error: " + e);
                                    }),
                                S(i.response, t.onProgress, t.enableStreamingDownload))
                              : 200 == n.status
                                ? ((i.response = n),
                                  (i.metaData.updatedAt = i.metaData.accessedAt),
                                  (i.revalidated = !0),
                                  (r = n.clone()),
                                  S(n, t.onProgress, t.enableStreamingDownload).then(function (t) {
                                      return (
                                          (i.metaData.size = t.parsedBody.length),
                                          Promise.all([o.storeRequest(e, r), o.updateRequestMetaData(i.metaData)])
                                              .then(function () {
                                                  P("'" + a + "' successfully downloaded and stored in the indexedDB cache");
                                              })
                                              .catch(function (e) {
                                                  P("'" + a + "' successfully downloaded but not stored in the indexedDB cache due to the error: " + e);
                                              }),
                                          t
                                      );
                                  }))
                                : (P("'" + a + "' request failed with status: " + n.status + ' ' + n.statusText), S(n, t.onProgress, t.enableStreamingDownload));
                    });
                }
                return (
                    t && ((i.control = t.control), (i.companyName = t.companyName), (i.productName = t.productName), (i.productVersion = t.productVersion)),
                    (i.revalidated = !1),
                    (i.metaData = { url: a, accessedAt: Date.now(), version: i.productVersion }),
                    (i.response = null),
                    i.enabled
                        ? o
                              .loadRequest(a)
                              .then(function (n) {
                                  ...
                                  return n
                                      ? ((r = n.response),
                                        (c = n.metaData),
                                        (i.response = r),
                                        (i.metaData.size = c.size),
                                        (i.metaData.updatedAt = c.updatedAt),
                                        'immutable' == i.control
                                            ? ((i.revalidated = !0),
                                              o.updateRequestMetaData(c).then(function () {
                                                  P("'" + i.metaData.url + "' served from the indexedDB cache without revalidation");
                                              }),
                                              S(r, t.onProgress, t.enableStreamingDownload))
                                            : ((n = a),
                                              ((u = window.location.href.match(/^[a-z]+:\/\/[^\/]+/)) && !n.lastIndexOf(u[0], 0)) || (!r.headers.get('Last-Modified') && !r.headers.get('ETag'))
                                                  ? ((n = (t = t || {}).headers || {}), (t.headers = n), r.headers.get('Last-Modified') ? ((n['If-Modified-Since'] = r.headers.get('Last-Modified')), (n['Cache-Control'] = 'no-cache')) : r.headers.get('ETag') && ((n['If-None-Match'] = r.headers.get('ETag')), (n['Cache-Control'] = 'no-cache')), s(e, t))
                                                  : fetch(a, { method: 'HEAD' }).then(function (n) {
                                                        return (
                              ...
                              .catch(function (n) {
                                  return (P("Failed to load '" + i.metaData.url + "' from indexedDB cache due to the error: " + n), w(e, t));
                              })
                        : w(e, t)
                );
            })),
        new Promise(function (e, t) {
            ...
            s.SystemInfo.hasWebGL
                ? 1 == s.SystemInfo.hasWebGL
                    ? ((o = 'Your browser does not support graphics API "WebGL 2" which is required for this content.'), 'Safari' == s.SystemInfo.browser && parseInt(s.SystemInfo.browserVersion) < 15 && (s.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? (o += '\nUpgrade to iOS 15 or later.') : (o += '\nUpgrade to Safari 15 or later.')), t(o))
                    : s.SystemInfo.hasWasm
                      ? ((s.startupErrorHandler = t),
                        ...
                        (function () {
                            (new Promise(function (e, t) {
                                loadUnityFramework(s.frameworkUrl, e);
                            }).then(function (e) {
                                e(s);
                            }),
                                x((e = 'dataUrl')),
                                (t = s.cacheControl(s[e])),
                                ...
                                (s.addRunDependency('dataUrl'),
                                    a.then(function (e) {
                                        var t = new DataView(e.buffer, e.byteOffset, e.byteLength),
                                            n = 0,
                                            r = 'UnityWebData1.0\0';
                                        if (!String.fromCharCode.apply(null, e.subarray(n, n + 16)) == r) throw 'unknown data format';
                                        var o = t.getUint32((n += 16), !0);
                                        for (n += 4; n < o; ) {
